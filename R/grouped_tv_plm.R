...
#'
#' @description Estimate a time-varying panel data model given an exogenous group structure. Coefficient functions are homogeneous within groups but heterogeneous across groups.
