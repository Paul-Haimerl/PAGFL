...
Furthermore, `dyn_pagfl` lets you specify a lot more optionalities than shown here. For example, it is possible to adjust the degree of the spline functions or the number of knots. See `?dyn_pagfl()` for details.
